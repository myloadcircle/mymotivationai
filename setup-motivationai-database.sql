-- MotivationAI Database Setup for Supabase
...
CREATE INDEX idx_habit_completions_completed_date ON habit_completions(completed_date);

CREATE INDEX idx_motivation_quotes_user_id ON motivation_quotes(user_id);
CREATE INDEX idx_motivation_quotes_category ON motivation_quotes(category);
...
CREATE INDEX idx_streak_logs_date ON streak_logs(date);
...
SELECT '✅ MotivationAI database tables created successfully!' as message;